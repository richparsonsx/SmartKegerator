...
int Graph::TimeSteps[] =    {1,  5,   15,   30,    60,    5*60,    15*60,   30*60,    60*60,    12*60*60,   24*60*60};
int Graph::DisplaySteps[] = {30, 120, 5*60, 10*60, 30*60, 2*60*60, 6*60*60, 12*60*60, 24*60*60, 14*24*60*60, 30*24*60*60};
